...
namespace DUC.CMS.CustomerService.DAL
{
    ...
    public partial class WORK_ORDER_TYPE
    {
        public WORK_ORDER_TYPE()
        {
            this.WORK_ORDER_REASON = new HashSet<WORK_ORDER_REASON>();
        ...
        public virtual ICollection<WORK_ORDER_REASON> WORK_ORDER_REASON { get; set; }
